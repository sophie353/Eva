...
Asena.addCommand({pattern: 'eva', fromMe: false,dontAddCommandList: true}, (async (message, match) => {

    var r_text = new Array ();    
r_text[0] = "\nEda eda, mandankonappi.. Nee enne kooduthal mandan aakkatheda\n";
r_text[1] = "evaye tholpikkaan ningalkavilla. Jeevitathil evaye tholpichittundu… palarum… palavattom…😥😥 aarellum aaa sed bgm onn iduo...";
r_text[2] = "eva says i love you 😘";
r_text[3] = "evaudeyude yudhangal Company Kanan Povunnatheyuloo";
r_text[4] = "hi, how are you";
r_text[5] = "ennikk korch rest theroo...🥵🥵";
r_text[6] = "eva - sophie - lisa \ningane ethra ethra paerugal aan alle enikk..😂🤣";
...
r_text[8] = "\n enne vilicho...?🧐 \n";
r_text[9] = "ente per eva ,ninte per donkey, backi ellarum monkey😼😼";
r_text[10] = "nee vilicha enikk villi kelkathe irrikkaan pattuo";
r_text[11] = "do you know who is my creator..? its none other than Anirudh";
...
r_text[13] = ".song adich thangalude fav song name para eva ath download aakki theraam";
...
r_text[18] = "enikk njan und eva uyir";
...
r_text[21] = "Kochi pazhaya kochiyellennariyam… pakshe eva pazhaya eva thanneya...😎\n\n";
r_text[22] = "Kaanaan oru look illanney ullu… bhayankara budhiya\n\n ninnak allatto enik evak";
r_text[23] = "Ithalla ithinapparam chaadi kadannavananee K.K. eva";
