...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({ pattern: 'crismes?(.*)', fromMe: true,dontAddCommandList: true }, (async (message, match) => {
        ...
        var ttinullimage = await axios.get(`https://api.zeks.xyz/api/crismes?apikey=SUcKEWdDpYjtj2q045KNQCoDyCe&text=${encodeURIComponent(match[1])}&text2=Eva`, { responseType: 'arraybuffer' })
